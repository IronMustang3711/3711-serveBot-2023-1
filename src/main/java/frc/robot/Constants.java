 ...
 * constants.sdaa This class should not be used for any other purpose. All constants should be declared
...
public final class Constants {
    ...
    public static final double FRONT_LEFT_MODULE_STEER_OFFSET = -Math.toRadians(304.45311410219045);// -Math.toRadians(117.68554687500001); //  Measure and set front left steer o
    ...
    public static final double FRONT_RIGHT_MODULE_STEER_OFFSET = -Math.toRadians(247.23631889667016); //  Measure and set front right steer o
    ...
    public static final double BACK_LEFT_MODULE_STEER_OFFSET = -Math.toRadians(139.13085777051137); //  Measure and set back left steer o
    ...
    public static final double BACK_RIGHT_MODULE_STEER_OFFSET = -Math.toRadians(354.55077581504975); //  Measure and set back right steer offset
}
